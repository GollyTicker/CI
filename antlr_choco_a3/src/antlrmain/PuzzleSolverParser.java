package antlrmain;// import zum manuellen Bauen der Trees
...
public class PuzzleSolverParser extends Parser {
    public static final String[] tokenNames = new String[] {
            "<invalid>", "<EOR>", "<DOWN>", "<UP>", "BLOCK", "CHAR", "CONDS", "EQ", "ESC_SEQ", "HEX_DIGIT", "ID", "NL", "OCTAL_ESC", "OP", "PLUS", "UNICODE_ESC", "WS"
    };
    ...
    public CommonTree buildFromBILD(String operator, Tree first, Tree second, Tree third) {
        CommonTree vertical = (CommonTree)adaptor.create(PLUS, "PLUS");// erzeugen eines PLUS Knotens
    ...
    // $ANTLR start "prog"
    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:65:1: prog : c1= row NL opRow= op_row NL c2= row NL eq_row NL c3= row ->;
    public final PuzzleSolverParser.prog_return prog() throws RecognitionException {
        ...
        try {
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:65:6: (c1= row NL opRow= op_row NL c2= row NL eq_row NL c3= row ->)
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:65:11: c1= row NL opRow= op_row NL c2= row NL eq_row NL c3= row
            {
                pushFollow(FOLLOW_row_in_prog74);
                c1=row();
                ...
                NL1=(Token)match(input,NL,FOLLOW_NL_in_prog76);
                stream_NL.add(NL1);


                pushFollow(FOLLOW_op_row_in_prog82);
                opRow=op_row();
                ...
                NL2=(Token)match(input,NL,FOLLOW_NL_in_prog84);
                stream_NL.add(NL2);


                pushFollow(FOLLOW_row_in_prog90);
                c2=row();
                ...
                NL3=(Token)match(input,NL,FOLLOW_NL_in_prog92);
                stream_NL.add(NL3);


                pushFollow(FOLLOW_eq_row_in_prog96);
                eq_row4=eq_row();
                ...
                NL5=(Token)match(input,NL,FOLLOW_NL_in_prog98);
                stream_NL.add(NL5);
    ...
    // $ANTLR start "row"
    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:108:1: row returns [Tree left, Tree mid, Tree right] : l= grouped_ids op= OP m= grouped_ids EQ r= grouped_ids -> { $op.text.trim().equals(\"-\") }? ^( PLUS $m $r $l) -> ^( PLUS $l $m $r) ;
    public final PuzzleSolverParser.row_return row() throws RecognitionException {
        ...
        try {
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:109:2: (l= grouped_ids op= OP m= grouped_ids EQ r= grouped_ids -> { $op.text.trim().equals(\"-\") }? ^( PLUS $m $r $l) -> ^( PLUS $l $m $r) )
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:110:2: l= grouped_ids op= OP m= grouped_ids EQ r= grouped_ids
            {
                pushFollow(FOLLOW_grouped_ids_in_row137);
                l=grouped_ids();
                ...
                op=(Token)match(input,OP,FOLLOW_OP_in_row141);
                stream_OP.add(op);


                pushFollow(FOLLOW_grouped_ids_in_row145);
                m=grouped_ids();
                ...
                EQ6=(Token)match(input,EQ,FOLLOW_EQ_in_row147);
                stream_EQ.add(EQ6);


                pushFollow(FOLLOW_grouped_ids_in_row151);
                r=grouped_ids();
                ...
                root_0 = (CommonTree)adaptor.nil();
                // 115:2: -> { $op.text.trim().equals(\"-\") }? ^( PLUS $m $r $l)
                if ( (op!=null?op.getText():null).trim().equals("-") ) {
                    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:115:38: ^( PLUS $m $r $l)
                    {
                ...
                else // 116:2: -> ^( PLUS $l $m $r)
                {
                    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:116:6: ^( PLUS $l $m $r)
                    {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                                (CommonTree)adaptor.create(PLUS, "PLUS")
    ...
    // $ANTLR start "op_row"
    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:120:1: op_row returns [String left, String mid, String right] : l= OP m= OP r= OP ;
    public final PuzzleSolverParser.op_row_return op_row() throws RecognitionException {
        ...
        try {
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:121:2: (l= OP m= OP r= OP )
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:121:6: l= OP m= OP r= OP
            {
                root_0 = (CommonTree)adaptor.nil();


                l=(Token)match(input,OP,FOLLOW_OP_in_op_row218);
                l_tree =
                ...
                m=(Token)match(input,OP,FOLLOW_OP_in_op_row222);
                m_tree =
                ...
                r=(Token)match(input,OP,FOLLOW_OP_in_op_row226);
                r_tree =
    ...
    // $ANTLR start "eq_row"
    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:127:1: eq_row : EQ ! EQ ! EQ !;
    public final PuzzleSolverParser.eq_row_return eq_row() throws RecognitionException {
        ...
        try {
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:128:5: ( EQ ! EQ ! EQ !)
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:128:10: EQ ! EQ ! EQ !
            {
                root_0 = (CommonTree)adaptor.nil();


                EQ7=(Token)match(input,EQ,FOLLOW_EQ_in_eq_row253);

                EQ8=(Token)match(input,EQ,FOLLOW_EQ_in_eq_row256);

                EQ9=(Token)match(input,EQ,FOLLOW_EQ_in_eq_row259);
    ...
    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:132:1: grouped_ids : ( ID )+ -> ^( BLOCK ( ID )+ ) ;
    public final PuzzleSolverParser.grouped_ids_return grouped_ids() throws RecognitionException {
        ...
        try {
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:133:2: ( ( ID )+ -> ^( BLOCK ( ID )+ ) )
            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:133:4: ( ID )+
            {
                // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:133:4: ( ID )+
                int cnt1=0;
                loop1:
                do {
                    ...
                    switch (alt1) {
                        case 1 :
                            // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:133:4: ID
                        {
                            ID10=(Token)match(input,ID,FOLLOW_ID_in_grouped_ids276);
                            stream_ID.add(ID10);
                ...
                // 133:8: -> ^( BLOCK ( ID )+ )
                {
                    // /Users/kbrusch/Google Drive/class/SS_2014/CI/swaneet/CI/A3/PuzzleSolver.g:133:11: ^( BLOCK ( ID )+ )
                    {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    public static final BitSet FOLLOW_row_in_prog74 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_NL_in_prog76 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_op_row_in_prog82 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_NL_in_prog84 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_row_in_prog90 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_NL_in_prog92 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_eq_row_in_prog96 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_NL_in_prog98 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_row_in_prog104 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_grouped_ids_in_row137 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_OP_in_row141 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_grouped_ids_in_row145 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_EQ_in_row147 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_grouped_ids_in_row151 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OP_in_op_row218 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_OP_in_op_row222 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_OP_in_op_row226 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EQ_in_eq_row253 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_EQ_in_eq_row256 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_EQ_in_eq_row259 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_grouped_ids276 = new BitSet(new long[]{0x0000000000000402L});
